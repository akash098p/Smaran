...
import com.smaran.app.SmaranActivityPhase3
...
class ReminderReceiver : BroadcastReceiver() {
    ...
    private fun showNotification(context: Context, taskId: Long, title: String, snoozedFor: Int?) {
        ...
        val openIntent = PendingIntent.getActivity(context, taskId.hashCode(), Intent(context, SmaranActivityPhase3::class.java), PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE)
        ...
        val rescheduleIntent = PendingIntent.getActivity(context, taskId.hashCode() + 9000, Intent(context, SmaranActivityPhase3::class.java).apply { putExtra(EXTRA_RESCHEDULE_TASK_ID, taskId) }, PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE)
